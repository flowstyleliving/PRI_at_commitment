...
### 2025-10-15 — `su-firewall` final form: chess analyzer with real Stockfish + uncertainty graph ♟️
...
### 2025-10-01 — Dual-model analysis: AI thinking from both sides ♟️🪞
...
### 2025-09-21 — FisherFlex + TemporalDrift: single-inference SU + temporal analysis 📐⏱️
...
### 2025-09-09 / 09-10 — Architectural reorganization: Confidence-Uncertainty separation + vLLM/GPT-OSS-20B 🏗️
...
### 2025-08-20 — Golden calibration `(λ=3.4, τ=0.5)` + Candle ML + 5-method ensemble ⚙️
...
### 2025-07-31 — Unified uncertainty calculator architecture 🏗️
...
### 2025-07-07 — `su-firewall` v1.5: Rust + Cloudflare Workers + Tier3 monitoring 🛠️
...
### 2025-06-17 — Semantic phase-transition analysis 🌡️
...
- 🛡️ **`su-firewall`** — *Semantic Uncertainty firewall → chess hallucination detection* (PRV) · 2025-07-04 → 2025-10-15 · production deployment track; furnace.baby; 0G blockchain integration; Mira grant; ~2.7 MB Rust + 520 KB Python + Next.js frontend; the longest-running and most product-shaped repo of the saga.
